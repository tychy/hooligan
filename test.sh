...
assert 10 "main(){ foo(); }"
assert 6 "main(){ two(3); }"
assert 48 "main(){ two(24); }"
assert 148 "main(){ two(5 * 20 - 2 * (6+7)); }"
assert 43 "main(){ BIG(33); }"
assert 25 "main(){ add(12,13); }"
assert 68 "main(){ add_tri(4, 50, 14); }"
assert 10 "main(){ add_qua(1,3,2,4); }"
assert 17 "main(){ add_pen(-100,200,57,-117,-23); }"
assert 23 "main(){ add_hex(23,19,-9,-15,5,0); }"
